...
def main():
    ...
    for epoch in range(epoches):
        ...
        print(
            f"Epoch {epoch+1}/{epoches} finished | Avg train loss: {avg_train_loss:.4f} | Avg train accuracy: {avg_train_accuracy*100:.2f}%"
        )
        ...
        with torch.no_grad():
            ...
            print(
            f"Epoch {epoch+1}/{epoches} finished | Avg validation mAP: {avg_validation_mAP:.4f} | Avg valiadtion accuracy: {avg_validation_accuracy*100:.2f}%"
            )
